...
<form id="myform" action="edit_food_pantry_sql.php" method="post">

<?php
$SiteID = $_SESSION['siteid'];
$conn = getConn();
$sql = "SELECT FacilityName, HoursOfOperation
FROM FoodPantry
WHERE FoodPantry.SiteID=$SiteID";
...
<form action="delete_food_pantry.php" method = "post"><input type="submit" value="delete service" name="delete"></form>
