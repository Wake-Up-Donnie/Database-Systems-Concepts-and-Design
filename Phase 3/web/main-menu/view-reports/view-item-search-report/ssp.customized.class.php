...
class SSP {
     ...
     *
     */
    static function simple ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery, $extraWhere, $groupBy = '')
    {
        $bindings = array();
        ...
        $extraWhere = self::_flatten( $extraWhere);
    ...
    static function sql_connect ( $sql_details )
    {
        try {
            $db = @new PDO(
                "mysql:host={$sql_details['host']};dbname={$sql_details['db']};port=8889",
                $sql_details['user'],
                $sql_details['pass'],
